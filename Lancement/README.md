...
Dossier de travail pour le plan d'action de lancement et la création de contenu.
...
- **Création de contenu/** — production de contenu pour le lancement (TikTok, Reels, Instagram, LinkedIn, X).
  ...
  - `Assets/compte-démo/` — compte de démonstration rempli (7 projets réalistes : voiture, appartement, rentrée scolaire, anniversaire surprise, freelance, courses, dentiste + Drop Zone garnie) pour tourner captures, vidéos et carrousels sans exposer de vraies données.
    - 13 captures d'écran (accueil, Drop Zone, priorités, Aujourd'hui, détail de projet, chat IA, menu, note…).
    - `dropit-demo-standalone.html` — le fichier autonome à ouvrir dans un navigateur pour filmer de vraies interactions (pas juste des images figées). N'écrit sur aucun compte réel — session et données simulées localement.
...
Ce dossier est prévu pour grossir : ajouter les vidéos/carrousels finalisés dans `Création de contenu/`, les décisions de prix/positionnement actées dans `Stratégie/`, etc.
